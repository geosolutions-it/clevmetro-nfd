...
require('../../MapStore2/web/client/plugins/map/css/map.css');
...
const MapPlugin = React.createClass({
    ...
    renderLayerContent(layer, projection) {
        if (layer.features && (layer.type === "vector" || layer.type === "clustermarker")) {
    ...
    updatePlugins(props) {
        plugins = require('../../MapStore2/web/client/plugins/map/index')(props.mapType, props.actions);
    }
});
...
module.exports = {
    ...
    reducers: { draw: require('../../MapStore2/web/client/reducers/draw') }
};
