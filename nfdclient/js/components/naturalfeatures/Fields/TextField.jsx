...
class TextField extends React.Component {
    ...
    renderVertical = () => {
        ...
        return this.state.full ? (<div className="input-full" onClick={this.fullClick}> {comp} <div type="button" className="btn btn-default back-button"><span className="glyphicon glyphicon-ok" aria-hidden="true"/></div></div>) : comp;
    }
    renderHorizontal = () => {
        const {item, editable, feature} = this.props;
        const readonly = !editable || !!item.readonly;
