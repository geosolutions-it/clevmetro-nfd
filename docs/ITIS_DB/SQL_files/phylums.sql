CREATE TABLE cmiphylums AS (

SELECT 
s.tsn AS species_tsn, t7.tsn AS phylum_tsn
FROM cmispecies s
...
SELECT 
s.tsn AS species_tsn, t6.tsn AS phylum_tsn
FROM cmispecies s
LEFT JOIN taxonomic_units t1 ON s.parent_tsn = t1.tsn
LEFT JOIN taxonomic_units t2 ON t1.parent_tsn = t2.tsn
LEFT JOIN taxonomic_units t3 ON t2.parent_tsn = t3.tsn
...
SELECT 
s.tsn AS species_tsn, t5.tsn AS phylum_tsn
FROM cmispecies s
LEFT JOIN taxonomic_units t1 ON s.parent_tsn = t1.tsn
LEFT JOIN taxonomic_units t2 ON t1.parent_tsn = t2.tsn
LEFT JOIN taxonomic_units t3 ON t2.parent_tsn = t3.tsn
...
SELECT 
s.tsn AS species_tsn, t4.tsn AS phylum_tsn
FROM cmispecies s
LEFT JOIN taxonomic_units t1 ON s.parent_tsn = t1.tsn
LEFT JOIN taxonomic_units t2 ON t1.parent_tsn = t2.tsn
LEFT JOIN taxonomic_units t3 ON t2.parent_tsn = t3.tsn
...
SELECT 
s.tsn AS species_tsn, t3.tsn AS phylum_tsn
FROM cmispecies s
LEFT JOIN taxonomic_units t1 ON s.parent_tsn = t1.tsn
LEFT JOIN taxonomic_units t2 ON t1.parent_tsn = t2.tsn
LEFT JOIN taxonomic_units t3 ON t2.parent_tsn = t3.tsn
...
SELECT 
s.tsn AS species_tsn, t2.tsn AS phylum_tsn
FROM cmispecies s
LEFT JOIN taxonomic_units t1 ON s.parent_tsn = t1.tsn
LEFT JOIN taxonomic_units t2 ON t1.parent_tsn = t2.tsn
WHERE ( 
...
SELECT 
s.tsn AS species_tsn, t1.tsn AS phylum_tsn
FROM cmispecies s
LEFT JOIN taxonomic_units t1 ON s.parent_tsn = t1.tsn
WHERE ( 
t1.rank_id = 30
